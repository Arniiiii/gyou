#ifndef INCLUDE_UTILS_DESIGNATED_ARRAY_INITIALIZERS_HPP_
#define INCLUDE_UTILS_DESIGNATED_ARRAY_INITIALIZERS_HPP_
    ...
    template <typename T, typename... Parts> struct ArrayBuilder
    {
      ...
      private:
        ...
        constexpr T initialize_for_index()
        {
            ...
            else if constexpr (std::tuple_element_t<J,
                                                    std::tuple<Parts...>>::index
                               == I)
                {
                    return std::apply(
...
#endif  // INCLUDE_UTILS_DESIGNATED_ARRAY_INITIALIZERS_HPP_
